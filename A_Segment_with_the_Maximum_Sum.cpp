...
void solve()
{
    ...
    function<long long(long long,long long,long long,long long,long long)>query=[&](long long ss,long long se,long long l,long long r,long long si)->long long{
        ...
        long long mid=(ss+se)/2;
        long long left=query(ss,mid,l,r,2*si+1);
        long long right=query(mid+1,se,l,r,2*si+2);
    ...
    {
        res.push_back(query(0,n-1,0,n-1,0));
        long long j,v;
        cin>>j>>v;
        arr[j]=v;
        update(0,n-1,0,j,v);
